...
public interface JmolJDXMOLParser {
  public abstract JmolJDXMOLParser set(JmolJDXMOLReader loader, String filePath, Map<String, Object> htParams);
  ...
  public abstract int readPeaks(boolean isSignals, int peakCount) throws Exception;
  ...
  int setACDAssignments(String model, String mytype, int peakCount, Lst<String[]> acdlist, String molFile) throws Exception;
}
