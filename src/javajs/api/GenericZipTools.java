...
public interface GenericZipTools {
	...
	public Object getZipFileDirectory(BufferedInputStream bis, String[] subFileList, int listPtr, boolean asBufferedInputStream);

	public String[] getZipDirectoryAndClose(BufferedInputStream t, String manifestID);

	public void getAllZipData(InputStream bis, String[] subFileList, String replace, String binaryFileList, String exclude, Map<String, String> fileData);

	public Object getZipFileContentsAsBytes(BufferedInputStream bis, String[] subFileList, int i);
	...
	public String cacheZipContents(BufferedInputStream bis, String shortName, Map<String, Object> cache, boolean asByteArray);
