...
public interface JmolAnnotationParser {
  ...
  void getAtomicDSSRData(ModelSet ms, int modelIndex, double[] dssrData, String dataType);
  ...
  Lst<Object> catalogValidations(Viewer vwr, SV validation, int[] modelAtomIndices, Map<String, int[]> valResMap, Map<String, Integer> map, Map<String, Integer> modelMap);
